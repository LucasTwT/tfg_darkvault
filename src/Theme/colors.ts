export const palette = {
    ...
    neutral900a: "rgba(66, 53, 77, .16)",

    primary100: "#DFC1FB", // titles Darkmode on
    ...
    primary900: "#400874", // bg form darkmode on and off
    primary900a: "rgba(64, 8, 116, .13)",
    primary900a2: "rgba(64, 8, 116, .04)",
    primary900a3: "rgba(64, 8, 116, .57)",
    primary900a4: "rgba(64, 8, 116, .30)",
    error400: "#ff6060", // error 

    shadowLinkDarkmode: "#FF00C8", // Shadow darkmode on
    shadowLink: "#1100FF", // shadow darkmode off
    shadowForm: "#0015FF",
    shadowInputPressedDarkmode: "#FFFF00", // Darkmode on
    shadowInputPressed: "#000000", // Darkmode off
    shadowIcButtonDarkmode: "rgba(89, 0, 255, .5)",
    shadowIcButton: "rgba(17, 0, 255, .4)"
}