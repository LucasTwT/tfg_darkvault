...
export default function MyCustomGlassTabBar({
  state,
  descriptors,
  navigation,
}) {
  ...
  const urlTabBar = theme.dark
    ? require("@/src/assets/images/BottomTabBarBlack.png")
    : require("@/src/assets/images/BottomTabBarWhite.png");
  return (
    <ImageBackground
      source={urlTabBar}
      resizeMode="contain"
