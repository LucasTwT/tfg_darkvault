...
export function CustomButton({ text, pressed, setPressed }: { text: string, pressed: boolean, setPressed: (state: boolean) => void }) {
  ...
  return (
    ...
    >
      <ButtonContent
        ...
        style={isFocused ? { backgroundColor: "rgba(0,0,0,0)" } : {}}
        activeOpacity={.5}
      >
